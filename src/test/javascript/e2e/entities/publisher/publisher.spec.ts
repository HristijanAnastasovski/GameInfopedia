...
import PublisherComponentsPage from './publisher.page-object';
import { PublisherDeleteDialog } from './publisher.page-object';
...
describe('Publisher e2e test', () => {
  ...
  it('should create and save Publishers', async () => {
    async function createPublisher() {
      ...
      await publisherUpdatePage.setCountryInput('country');
      expect(await publisherUpdatePage.getCountryInput()).to.match(/country/);
      await publisherUpdatePage.setDescriptionInput('description');
      expect(await publisherUpdatePage.getDescriptionInput()).to.match(/description/);
  ...
  it('should delete last Publisher', async () => {
    ...
    expect(await publisherDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gameInfopediaApp.publisher.delete.question/);
